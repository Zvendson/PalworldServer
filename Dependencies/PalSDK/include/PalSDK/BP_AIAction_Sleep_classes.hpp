...
public:
	...
	void OnAllActionFinishDelegate______________0(const class UPalActionComponent* ActionComponent);
	void OnDamageDelegate______________0(const struct FPalDamageResult& DamageResult);
