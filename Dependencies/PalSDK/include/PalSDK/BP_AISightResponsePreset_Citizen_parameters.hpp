...
struct BP_AISightResponsePreset_Citizen_C__________________________0 final
{
public:
...
static_assert(alignof(BP_AISightResponsePreset_Citizen_C__________________________0) == 0x000008, "Wrong alignment on BP_AISightResponsePreset_Citizen_C__________________________0");
static_assert(sizeof(BP_AISightResponsePreset_Citizen_C__________________________0) == 0x000010, "Wrong size on BP_AISightResponsePreset_Citizen_C__________________________0");
static_assert(offsetof(BP_AISightResponsePreset_Citizen_C__________________________0, SelfCharacter) == 0x000000, "Member 'BP_AISightResponsePreset_Citizen_C__________________________0::SelfCharacter' has a wrong offset!");
static_assert(offsetof(BP_AISightResponsePreset_Citizen_C__________________________0, FoundCharacter) == 0x000008, "Member 'BP_AISightResponsePreset_Citizen_C__________________________0::FoundCharacter' has a wrong offset!");
