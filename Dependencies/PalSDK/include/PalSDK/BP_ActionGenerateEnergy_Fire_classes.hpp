...
static_assert(offsetof(UBP_ActionGenerateEnergy_Fire_C, _______________) == 0x000148, "Member 'UBP_ActionGenerateEnergy_Fire_C::_______________' has a wrong offset!");
