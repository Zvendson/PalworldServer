...
class ABP_Baphomet_C final : public ABP_MonsterBase_C
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_Baphomet_C">();
	}
	static class ABP_Baphomet_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Baphomet_C>();
	}
};
static_assert(alignof(ABP_Baphomet_C) == 0x000010, "Wrong alignment on ABP_Baphomet_C");
static_assert(sizeof(ABP_Baphomet_C) == 0x000AA0, "Wrong size on ABP_Baphomet_C");
static_assert(offsetof(ABP_Baphomet_C, PalSpeedCollision) == 0x000A60, "Member 'ABP_Baphomet_C::PalSpeedCollision' has a wrong offset!");
static_assert(offsetof(ABP_Baphomet_C, PalBodyPartsCapsule5) == 0x000A68, "Member 'ABP_Baphomet_C::PalBodyPartsCapsule5' has a wrong offset!");
static_assert(offsetof(ABP_Baphomet_C, PalBodyPartsCapsule4) == 0x000A70, "Member 'ABP_Baphomet_C::PalBodyPartsCapsule4' has a wrong offset!");
static_assert(offsetof(ABP_Baphomet_C, PalBodyPartsCapsule3) == 0x000A78, "Member 'ABP_Baphomet_C::PalBodyPartsCapsule3' has a wrong offset!");
static_assert(offsetof(ABP_Baphomet_C, PalBodyPartsCapsule2) == 0x000A80, "Member 'ABP_Baphomet_C::PalBodyPartsCapsule2' has a wrong offset!");
static_assert(offsetof(ABP_Baphomet_C, PalBodyPartsCapsule1) == 0x000A88, "Member 'ABP_Baphomet_C::PalBodyPartsCapsule1' has a wrong offset!");
static_assert(offsetof(ABP_Baphomet_C, PalBodyPartsCapsule) == 0x000A90, "Member 'ABP_Baphomet_C::PalBodyPartsCapsule' has a wrong offset!");
static_assert(offsetof(ABP_Baphomet_C, PalBodyPartsSphere) == 0x000A98, "Member 'ABP_Baphomet_C::PalBodyPartsSphere' has a wrong offset!");
