...
// 0x0008 (0x0008 - 0x0000)
struct BP_MonsterAIController_Invader_C__________________________1 final
{
public:
...
static_assert(alignof(BP_MonsterAIController_Invader_C__________________________1) == 0x000008, "Wrong alignment on BP_MonsterAIController_Invader_C__________________________1");
static_assert(sizeof(BP_MonsterAIController_Invader_C__________________________1) == 0x000008, "Wrong size on BP_MonsterAIController_Invader_C__________________________1");
static_assert(offsetof(BP_MonsterAIController_Invader_C__________________________1, InCharacter) == 0x000000, "Member 'BP_MonsterAIController_Invader_C__________________________1::InCharacter' has a wrong offset!");

// Function BP_MonsterAIController_Invader.BP_MonsterAIController_Invader_C.カスタムイベント_OnDead
// 0x0050 (0x0050 - 0x0000)
struct BP_MonsterAIController_Invader_C__________________________OnDead final
{
public:
	struct FPalDeadInfo                           DeadInfo;                                          // 0x0000(0x0050)(BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
};
static_assert(alignof(BP_MonsterAIController_Invader_C__________________________OnDead) == 0x000008, "Wrong alignment on BP_MonsterAIController_Invader_C__________________________OnDead");
static_assert(sizeof(BP_MonsterAIController_Invader_C__________________________OnDead) == 0x000050, "Wrong size on BP_MonsterAIController_Invader_C__________________________OnDead");
static_assert(offsetof(BP_MonsterAIController_Invader_C__________________________OnDead, DeadInfo) == 0x000000, "Member 'BP_MonsterAIController_Invader_C__________________________OnDead::DeadInfo' has a wrong offset!");
