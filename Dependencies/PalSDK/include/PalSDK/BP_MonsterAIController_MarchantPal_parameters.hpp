...
struct BP_MonsterAIController_MarchantPal_C_________________________ final
{
public:
	struct FPalInstanceID                         ID;                                                // 0x0000(0x0030)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
};
static_assert(alignof(BP_MonsterAIController_MarchantPal_C_________________________) == 0x000008, "Wrong alignment on BP_MonsterAIController_MarchantPal_C_________________________");
static_assert(sizeof(BP_MonsterAIController_MarchantPal_C_________________________) == 0x000030, "Wrong size on BP_MonsterAIController_MarchantPal_C_________________________");
static_assert(offsetof(BP_MonsterAIController_MarchantPal_C_________________________, ID) == 0x000000, "Member 'BP_MonsterAIController_MarchantPal_C_________________________::ID' has a wrong offset!");

// Function BP_MonsterAIController_MarchantPal.BP_MonsterAIController_MarchantPal_C.カスタムイベント_1
// 0x0050 (0x0050 - 0x0000)
struct BP_MonsterAIController_MarchantPal_C__________________________1 final
{
public:
	struct FPalDeadInfo                           DeadInfo;                                          // 0x0000(0x0050)(BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
};
static_assert(alignof(BP_MonsterAIController_MarchantPal_C__________________________1) == 0x000008, "Wrong alignment on BP_MonsterAIController_MarchantPal_C__________________________1");
static_assert(sizeof(BP_MonsterAIController_MarchantPal_C__________________________1) == 0x000050, "Wrong size on BP_MonsterAIController_MarchantPal_C__________________________1");
static_assert(offsetof(BP_MonsterAIController_MarchantPal_C__________________________1, DeadInfo) == 0x000000, "Member 'BP_MonsterAIController_MarchantPal_C__________________________1::DeadInfo' has a wrong offset!");

// Function BP_MonsterAIController_MarchantPal.BP_MonsterAIController_MarchantPal_C.カスタムイベント_2
// 0x0008 (0x0008 - 0x0000)
struct BP_MonsterAIController_MarchantPal_C__________________________2 final
{
public:
...
static_assert(alignof(BP_MonsterAIController_MarchantPal_C__________________________2) == 0x000008, "Wrong alignment on BP_MonsterAIController_MarchantPal_C__________________________2");
static_assert(sizeof(BP_MonsterAIController_MarchantPal_C__________________________2) == 0x000008, "Wrong size on BP_MonsterAIController_MarchantPal_C__________________________2");
static_assert(offsetof(BP_MonsterAIController_MarchantPal_C__________________________2, VisualEffect) == 0x000000, "Member 'BP_MonsterAIController_MarchantPal_C__________________________2::VisualEffect' has a wrong offset!");
