...
// 0x0008 (0x0008 - 0x0000)
struct BP_PlayerBase_C_OnCompleteInitializeParameterDelegate______________0 final
{
public:
...
static_assert(alignof(BP_PlayerBase_C_OnCompleteInitializeParameterDelegate______________0) == 0x000008, "Wrong alignment on BP_PlayerBase_C_OnCompleteInitializeParameterDelegate______________0");
static_assert(sizeof(BP_PlayerBase_C_OnCompleteInitializeParameterDelegate______________0) == 0x000008, "Wrong size on BP_PlayerBase_C_OnCompleteInitializeParameterDelegate______________0");
static_assert(offsetof(BP_PlayerBase_C_OnCompleteInitializeParameterDelegate______________0, InCharacter) == 0x000000, "Member 'BP_PlayerBase_C_OnCompleteInitializeParameterDelegate______________0::InCharacter' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct BP_PlayerBase_C_OnUpdateLevelDelegate______________0 final
{
public:
...
static_assert(alignof(BP_PlayerBase_C_OnUpdateLevelDelegate______________0) == 0x000004, "Wrong alignment on BP_PlayerBase_C_OnUpdateLevelDelegate______________0");
static_assert(sizeof(BP_PlayerBase_C_OnUpdateLevelDelegate______________0) == 0x000008, "Wrong size on BP_PlayerBase_C_OnUpdateLevelDelegate______________0");
static_assert(offsetof(BP_PlayerBase_C_OnUpdateLevelDelegate______________0, AddLevel) == 0x000000, "Member 'BP_PlayerBase_C_OnUpdateLevelDelegate______________0::AddLevel' has a wrong offset!");
static_assert(offsetof(BP_PlayerBase_C_OnUpdateLevelDelegate______________0, NowLevel) == 0x000004, "Member 'BP_PlayerBase_C_OnUpdateLevelDelegate______________0::NowLevel' has a wrong offset!");
