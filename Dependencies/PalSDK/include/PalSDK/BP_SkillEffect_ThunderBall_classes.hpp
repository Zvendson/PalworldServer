...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_SkillEffect_ThunderBall_C;       // 0x03C0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_SkillEffect_ThunderBall_C">();
	}
...
static_assert(alignof(ABP_SkillEffect_ThunderBall_C) == 0x000008, "Wrong alignment on ABP_SkillEffect_ThunderBall_C");
static_assert(sizeof(ABP_SkillEffect_ThunderBall_C) == 0x0003E8, "Wrong size on ABP_SkillEffect_ThunderBall_C");
static_assert(offsetof(ABP_SkillEffect_ThunderBall_C, UberGraphFrame_BP_SkillEffect_ThunderBall_C) == 0x0003C0, "Member 'ABP_SkillEffect_ThunderBall_C::UberGraphFrame_BP_SkillEffect_ThunderBall_C' has a wrong offset!");
static_assert(offsetof(ABP_SkillEffect_ThunderBall_C, ProjectileMovement) == 0x0003C8, "Member 'ABP_SkillEffect_ThunderBall_C::ProjectileMovement' has a wrong offset!");
static_assert(offsetof(ABP_SkillEffect_ThunderBall_C, DamageCollisionSphere) == 0x0003D0, "Member 'ABP_SkillEffect_ThunderBall_C::DamageCollisionSphere' has a wrong offset!");
static_assert(offsetof(ABP_SkillEffect_ThunderBall_C, P_Pentagon01) == 0x0003D8, "Member 'ABP_SkillEffect_ThunderBall_C::P_Pentagon01' has a wrong offset!");
static_assert(offsetof(ABP_SkillEffect_ThunderBall_C, SkillDuration) == 0x0003E0, "Member 'ABP_SkillEffect_ThunderBall_C::SkillDuration' has a wrong offset!");
