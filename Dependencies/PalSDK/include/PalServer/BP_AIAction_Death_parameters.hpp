...
// 0x0008 (0x0008 - 0x0000)
struct BP_AIAction_Death_C__________________________0 final
{
public:
...
static_assert(alignof(BP_AIAction_Death_C__________________________0) == 0x000008, "Wrong alignment on BP_AIAction_Death_C__________________________0");
static_assert(sizeof(BP_AIAction_Death_C__________________________0) == 0x000008, "Wrong size on BP_AIAction_Death_C__________________________0");
static_assert(offsetof(BP_AIAction_Death_C__________________________0, IndividualParameter) == 0x000000, "Member 'BP_AIAction_Death_C__________________________0::IndividualParameter' has a wrong offset!");
