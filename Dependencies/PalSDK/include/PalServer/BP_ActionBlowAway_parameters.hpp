...
struct BP_ActionBlowAway_C_OnLandedDelegate______________0 final
{
public:
...
static_assert(alignof(BP_ActionBlowAway_C_OnLandedDelegate______________0) == 0x000008, "Wrong alignment on BP_ActionBlowAway_C_OnLandedDelegate______________0");
static_assert(sizeof(BP_ActionBlowAway_C_OnLandedDelegate______________0) == 0x0000F0, "Wrong size on BP_ActionBlowAway_C_OnLandedDelegate______________0");
static_assert(offsetof(BP_ActionBlowAway_C_OnLandedDelegate______________0, Component) == 0x000000, "Member 'BP_ActionBlowAway_C_OnLandedDelegate______________0::Component' has a wrong offset!");
static_assert(offsetof(BP_ActionBlowAway_C_OnLandedDelegate______________0, Hit) == 0x000008, "Member 'BP_ActionBlowAway_C_OnLandedDelegate______________0::Hit' has a wrong offset!");
