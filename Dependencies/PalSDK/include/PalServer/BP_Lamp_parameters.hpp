...
struct BP_Lamp_C_OnChangeCrouchDelegate______________0 final
{
public:
...
static_assert(alignof(BP_Lamp_C_OnChangeCrouchDelegate______________0) == 0x000008, "Wrong alignment on BP_Lamp_C_OnChangeCrouchDelegate______________0");
static_assert(sizeof(BP_Lamp_C_OnChangeCrouchDelegate______________0) == 0x000010, "Wrong size on BP_Lamp_C_OnChangeCrouchDelegate______________0");
static_assert(offsetof(BP_Lamp_C_OnChangeCrouchDelegate______________0, Component) == 0x000000, "Member 'BP_Lamp_C_OnChangeCrouchDelegate______________0::Component' has a wrong offset!");
static_assert(offsetof(BP_Lamp_C_OnChangeCrouchDelegate______________0, IsInCrouch) == 0x000008, "Member 'BP_Lamp_C_OnChangeCrouchDelegate______________0::IsInCrouch' has a wrong offset!");
