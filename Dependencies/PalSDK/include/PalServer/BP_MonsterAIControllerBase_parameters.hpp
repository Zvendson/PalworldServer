...
// 0x0008 (0x0008 - 0x0000)
struct BP_MonsterAIControllerBase_C__________________________0 final
{
public:
...
static_assert(alignof(BP_MonsterAIControllerBase_C__________________________0) == 0x000008, "Wrong alignment on BP_MonsterAIControllerBase_C__________________________0");
static_assert(sizeof(BP_MonsterAIControllerBase_C__________________________0) == 0x000008, "Wrong size on BP_MonsterAIControllerBase_C__________________________0");
static_assert(offsetof(BP_MonsterAIControllerBase_C__________________________0, InCharacter) == 0x000000, "Member 'BP_MonsterAIControllerBase_C__________________________0::InCharacter' has a wrong offset!");
