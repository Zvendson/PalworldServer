...
struct BP_PlayerSoundEmitterComponent_C__________________________1 final
{
public:
...
static_assert(alignof(BP_PlayerSoundEmitterComponent_C__________________________1) == 0x000008, "Wrong alignment on BP_PlayerSoundEmitterComponent_C__________________________1");
static_assert(sizeof(BP_PlayerSoundEmitterComponent_C__________________________1) == 0x0000F0, "Wrong size on BP_PlayerSoundEmitterComponent_C__________________________1");
static_assert(offsetof(BP_PlayerSoundEmitterComponent_C__________________________1, Component) == 0x000000, "Member 'BP_PlayerSoundEmitterComponent_C__________________________1::Component' has a wrong offset!");
static_assert(offsetof(BP_PlayerSoundEmitterComponent_C__________________________1, Hit) == 0x000008, "Member 'BP_PlayerSoundEmitterComponent_C__________________________1::Hit' has a wrong offset!");
