...
#include "PalSDK/BP_BuildObject_Wood_Stair_parameters.hpp"
...
void ABP_BuildObject_Wood_Stair_C::GetStaticMeshComponents(TArray<class UStaticMeshComponent*>* OutComponents) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_BuildObject_Wood_Stair_C", "GetStaticMeshComponents");

	Params::BP_BuildObject_Wood_Stair_C_GetStaticMeshComponents Parms{};
