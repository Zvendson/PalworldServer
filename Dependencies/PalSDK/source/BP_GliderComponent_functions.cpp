...
// Function BP_GliderComponent.BP_GliderComponent_C.カスタムイベント
// (BlueprintCallable, BlueprintEvent)

void UBP_GliderComponent_C::________________________()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GliderComponent_C", "カスタムイベント");
