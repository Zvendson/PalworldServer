...
#include "PalServer/BP_MonsterAIController_BaseCamp_parameters.hpp"
...
void ABP_MonsterAIController_BaseCamp_C::OnDeadDelegate______________0(const struct FPalDeadInfo& DeadInfo)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_MonsterAIController_BaseCamp_C", "OnDeadDelegate_イベント_0");

	Params::BP_MonsterAIController_BaseCamp_C_OnDeadDelegate______________0 Parms{};
