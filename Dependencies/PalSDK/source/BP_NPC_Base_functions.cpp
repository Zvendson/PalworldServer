...
void ABP_NPC_Base_C::_________________________0(class APalCharacter* InCharacter)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_NPC_Base_C", "カスタムイベント_0");

	Params::BP_NPC_Base_C__________________________0 Parms{};
...
void ABP_NPC_Base_C::_________________________2(const struct FPalDeadInfo& DeadInfo)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_NPC_Base_C", "カスタムイベント_2");

	Params::BP_NPC_Base_C__________________________2 Parms{};
