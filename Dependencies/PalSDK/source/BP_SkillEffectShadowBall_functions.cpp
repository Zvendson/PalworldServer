...
#include "PalSDK/BP_SkillEffectShadowBall_parameters.hpp"
...
void ABP_SkillEffectShadowBall_C::BndEvt__BP_SkillEffectShadowBall_AttackFilter_K2Node_ComponentBoundEvent_1_OnAttackDelegate__DelegateSignature(class AActor* Defencer, const struct FPalDamageInfo& DamageInfo, int32 HitCount, class UPrimitiveComponent* AttackerComponent)
{
	...
	Params::BP_SkillEffectShadowBall_C_BndEvt__BP_SkillEffectShadowBall_AttackFilter_K2Node_ComponentBoundEvent_1_OnAttackDelegate__DelegateSignature Parms{};
...
void ABP_SkillEffectShadowBall_C::BndEvt__BP_SkillEffectShadowBall_MovementSphereRoot_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
{
	...
	Params::BP_SkillEffectShadowBall_C_BndEvt__BP_SkillEffectShadowBall_MovementSphereRoot_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature Parms{};
...
void ABP_SkillEffectShadowBall_C::ExecuteUbergraph_BP_SkillEffectShadowBall(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkillEffectShadowBall_C_ExecuteUbergraph_BP_SkillEffectShadowBall Parms{};
...
void ABP_SkillEffectShadowBall_C::FadeOutEffect(double DeltaSecond)
{
	...
	Params::BP_SkillEffectShadowBall_C_FadeOutEffect Parms{};
