...
#include "PalSDK/BP_SkillEffect_ThunderBall_parameters.hpp"
...
void ABP_SkillEffect_ThunderBall_C::BndEvt__BP_SkillEffect_ThunderBall_AttackFilter_K2Node_ComponentBoundEvent_1_OnAttackDelegate__DelegateSignature(class AActor* Defencer, const struct FPalDamageInfo& DamageInfo, int32 HitCount, class UPrimitiveComponent* AttackerComponent)
{
	...
	Params::BP_SkillEffect_ThunderBall_C_BndEvt__BP_SkillEffect_ThunderBall_AttackFilter_K2Node_ComponentBoundEvent_1_OnAttackDelegate__DelegateSignature Parms{};
...
void ABP_SkillEffect_ThunderBall_C::BndEvt__BP_SkillEffect_ThunderBall_MovementSphereRoot_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
{
	...
	Params::BP_SkillEffect_ThunderBall_C_BndEvt__BP_SkillEffect_ThunderBall_MovementSphereRoot_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature Parms{};
...
void ABP_SkillEffect_ThunderBall_C::ExecuteUbergraph_BP_SkillEffect_ThunderBall(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkillEffect_ThunderBall_C_ExecuteUbergraph_BP_SkillEffect_ThunderBall Parms{};
