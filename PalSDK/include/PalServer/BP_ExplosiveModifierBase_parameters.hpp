...
struct BP_ExplosiveModifierBase_C__________________________0 final
{
public:
...
static_assert(alignof(BP_ExplosiveModifierBase_C__________________________0) == 0x000008, "Wrong alignment on BP_ExplosiveModifierBase_C__________________________0");
static_assert(sizeof(BP_ExplosiveModifierBase_C__________________________0) == 0x000100, "Wrong size on BP_ExplosiveModifierBase_C__________________________0");
static_assert(offsetof(BP_ExplosiveModifierBase_C__________________________0, HitComp) == 0x000000, "Member 'BP_ExplosiveModifierBase_C__________________________0::HitComp' has a wrong offset!");
static_assert(offsetof(BP_ExplosiveModifierBase_C__________________________0, OtherCharacter) == 0x000008, "Member 'BP_ExplosiveModifierBase_C__________________________0::OtherCharacter' has a wrong offset!");
static_assert(offsetof(BP_ExplosiveModifierBase_C__________________________0, OtherComp) == 0x000010, "Member 'BP_ExplosiveModifierBase_C__________________________0::OtherComp' has a wrong offset!");
static_assert(offsetof(BP_ExplosiveModifierBase_C__________________________0, Hi) == 0x000018, "Member 'BP_ExplosiveModifierBase_C__________________________0::Hi' has a wrong offset!");
