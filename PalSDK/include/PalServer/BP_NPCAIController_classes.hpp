...
public:
	...
	void _________________________0(const struct FPalInstanceID& ID);
	void _________________________1();
	void _________________________2(const struct FPalDeadInfo& DeadInfo);
	void _________________________4(class AController* HolderController, class APalCharacter* OtomoPal);
