...
// 0x0008 (0x0008 - 0x0000)
struct BP_NPC_Base_C__________________________0 final
{
public:
...
static_assert(alignof(BP_NPC_Base_C__________________________0) == 0x000008, "Wrong alignment on BP_NPC_Base_C__________________________0");
static_assert(sizeof(BP_NPC_Base_C__________________________0) == 0x000008, "Wrong size on BP_NPC_Base_C__________________________0");
static_assert(offsetof(BP_NPC_Base_C__________________________0, InCharacter) == 0x000000, "Member 'BP_NPC_Base_C__________________________0::InCharacter' has a wrong offset!");

// Function BP_NPC_Base.BP_NPC_Base_C.カスタムイベント_2
// 0x0050 (0x0050 - 0x0000)
struct BP_NPC_Base_C__________________________2 final
{
public:
	struct FPalDeadInfo                           DeadInfo;                                          // 0x0000(0x0050)(BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
};
static_assert(alignof(BP_NPC_Base_C__________________________2) == 0x000008, "Wrong alignment on BP_NPC_Base_C__________________________2");
static_assert(sizeof(BP_NPC_Base_C__________________________2) == 0x000050, "Wrong size on BP_NPC_Base_C__________________________2");
static_assert(offsetof(BP_NPC_Base_C__________________________2, DeadInfo) == 0x000000, "Member 'BP_NPC_Base_C__________________________2::DeadInfo' has a wrong offset!");
