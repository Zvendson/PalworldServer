...
#include "PalServer/BP_PalGameInstance_parameters.hpp"
...
void UBP_PalGameInstance_C::________________________(bool bResult)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PalGameInstance_C", "カスタムイベント");

	Params::BP_PalGameInstance_C_________________________ Parms{};
