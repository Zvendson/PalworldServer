...
#include "PalServer/BP_SkillEffectBase_parameters.hpp"
...
void ABP_SkillEffectBase_C::OnHitDelegate_____________(class UPrimitiveComponent* MyHitComponent, class AActor* OtherHitActor, class UPrimitiveComponent* OtherHitComponent, const TArray<int32>& FoliageIndex, const struct FVector& HitLocation, int32 HitCount)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SkillEffectBase_C", "OnHitDelegate_イベント");

	Params::BP_SkillEffectBase_C_OnHitDelegate_____________ Parms{};
