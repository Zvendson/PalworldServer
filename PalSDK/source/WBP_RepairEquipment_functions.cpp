...
void UWBP_RepairEquipment_C::OnClosedRepairAllWindow(class UPalHUDDispatchParameterBase* Param_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_RepairEquipment_C_OnClosedRepairAllWindow Parms{};
...
class UWidget* UWBP_RepairEquipment_C::BP_GetDesiredFocusTarget() const
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_RepairEquipment_C_BP_GetDesiredFocusTarget Parms{};
